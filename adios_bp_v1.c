                        ...
                        )
{
    ...
    *version = ntohl (*(uint32_t *) (b->buff + b->offset));
    ...
    if (   (!*(char *) version && !*(char *) &test) // big endian
        || (*(char *) version && *(char *) &test) // little endian
       )
    {
                    ...
                    case adios_characteristic_max:
                    {
                        ...
                        switch ((*root)->type)
                        {
                            ...
                            case adios_double_complex:
                                ...
                                if(b->change_endianness == adios_flag_yes) {
                                    if((*root)->type == adios_long_double) {
									    // TODO
									}
									else if((*root)->type == adios_complex) {
                                        // TODO
									}
