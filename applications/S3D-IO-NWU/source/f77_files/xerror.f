...
C
C	this is CHEMKIN-III file xerror. V.3.3 June, 2000;
...
C
C     Changes for v. 3.3: (E. Meeks)
C     1) Added subroutines XERRWD, XERSVE, XGETUA,
C        XSETUN, XSETF, IXSAV,  from DDASPK and VODE
C     Changes for v. 3.2: (E. Meeks)
C     1) Replaced STOP statements with RETURN in XERRWV and XERHLT.
...
C <error module="xerror" severity="error">
C <id>1</id>
C <message>The SLATEC error-handling routine was called with
C  a fatal error and the following message: %1
C </message>
C </error>
CEM      STOP
      RETURN
...
C <error module="xerror" severity="warning">
C <id>2</id>
C <message>The SLATEC error-handling routine
C  gave the following warning message:  %1
C </message>
C </error>
      ELSE
C <error module="xerror" severity="error">
C <id>3</id>
C <message>The SLATEC error-handling routine was called with
C  a fatal error, with the following message: %1
C </message>
C </error>
      ENDIF
CEM      STOP
...
C <error module="xerror" severity="warning">
C <id>1</id>
C <message>The SLATEC Error handler, XERROR,
C  gave the following warning message:  %1
C </message>
C </error>
      ELSE
...
C <id>2</id>
C <message>The SLATEC Error handler, XERROR,
C  encountered a fatal error, with the following message: %1
C </message>
C </error>
      ENDIF
CEM      STOP
