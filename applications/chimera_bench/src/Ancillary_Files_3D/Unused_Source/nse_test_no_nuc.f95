SUBROUTINE nse_test( jr_min, jr_max, ij_ray, ik_ray, ij_ray_dim, ik_ray_dim )
!-----------------------------------------------------------------------
!
!    File:         nse_test
!    Module:       nse_test
...
!  nucbrn_module, parallel_module, prb_cntl_module, t_cntrl_module
!
!-----------------------------------------------------------------------
...
!-----------------------------------------------------------------------
  ...
  eos_reset          = 'y'
  CALL deflash_x( j_tstm1, ij_ray, ik_ray, eos_reset )
...
!-----------------------------------------------------------------------
  ...
  CALL set_cube_j( j_tstm1, ij_ray, ik_ray )
