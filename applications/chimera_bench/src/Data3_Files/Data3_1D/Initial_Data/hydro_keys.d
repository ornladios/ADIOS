...
!           x-sweeps.
!
!          tcntrl(4): Courant condition - tcntrl(1) is the fraction of a
!           zone width a sonic disturbance is allowed to propagate in the
...
!           y-sweeps.
!
!          tcntrl(9) : convective time step control - tcntrl(7) is the fraction
!           of a zone width a convective blob is allowed to propagate in one time step.
!
!          tcntrl(10): maximum increase in the 'hydro' time step, i.e., the maximum
!           allowed value of dtnph/dtnmh.
!
