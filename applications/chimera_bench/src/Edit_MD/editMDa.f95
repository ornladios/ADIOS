SUBROUTINE editMDa( imin, imax, nx, jmin, jmax, ny, kmin, kmax, nz, x_in, &
& y_in, z_in, time, t_tb, aMD, nprint )
!-----------------------------------------------------------------------
!
!    File:         editMDa
!    Module:       editMDa
...
!
!    Purpose:
!  To perform an edit of the mean nuclear mass numbers.
!
!    Subprograms call:
...
REAL(KIND=double), INTENT(in), DIMENSION(nx,ny,nz) :: aMD            ! entropy of zone
