SUBROUTINE editMDcomp( imin, imax, nx, jmin, jmax, ny, kmin, kmax, nz, x_in, &
& y_in, z_in, time, t_tb, i_comp, nprint )
!-----------------------------------------------------------------------
!
!    File:         editMDcomp
!    Module:       editMDcomp
...
!
!    Purpose:
!  To perform an edit of the mach numbers
!
!    Subprograms call:
...
INTEGER, INTENT(in), DIMENSION(nx,ny,nz)         :: i_comp         ! integer denoting the dominant element
