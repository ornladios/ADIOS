SUBROUTINE editMDd( imin, imax, nx, jmin, jmax, ny, kmin, kmax, nz, x_in, &
& y_in, z_in, time, t_tb, rhoMD, nprint )
!-----------------------------------------------------------------------
!
!    File:         editMDd
!    Module:       editMDd
...
!
!    Purpose:
!  To perform an edit of the densities.
!
!    Subprograms call:
...
REAL(KIND=double), INTENT(in), DIMENSION(nx,ny,nz) :: rhoMD          ! density of zone (g cm^{-3})
