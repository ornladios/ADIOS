SUBROUTINE editMDdudt_nuc( imin, imax, nx, jmin, jmax, ny, kmin, kmax, &
& nz, x_in, y_in, z_in, time, t_tb, dudt_nucMD, nprint )
!-----------------------------------------------------------------------
!
!    File:         editMDdudt_nuc
!    Module:       editMDdudt_nuc
!    Type:         Subprogram
...
WRITE (nprint) y_in
WRITE (nprint) z_in
WRITE (nprint) dudt_nucMD

RETURN
END SUBROUTINE editMDdudt_nuc
