SUBROUTINE editMDenu( imin, imax, nx, jmin, jmax, ny, kmin, kmax, nz, x_in, &
& y_in, z_in, time, t_tb, e_nu_MD, nprint )
!-----------------------------------------------------------------------
!
!    File:         editMDenu
!    Module:       editMDenu
...
REAL(KIND=double), INTENT(in), DIMENSION(nx,ny,nz) :: e_nu_MD        ! neutrino energy density (ergs g^{-1})
...
WRITE (nprint) y_in
WRITE (nprint) z_in
WRITE (nprint) e_nu_MD

RETURN
END SUBROUTINE editMDenu