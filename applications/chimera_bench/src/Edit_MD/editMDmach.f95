SUBROUTINE editMDmach( imin, imax, nx, jmin, jmax, ny, kmin, kmax, nz, &
& x_in, y_in, z_in, time, t_tb, v_csoundMD, nprint )
!-----------------------------------------------------------------------
!
!    File:         editMDmach
!    Module:       editMDmach
...
WRITE (nprint) y_in
WRITE (nprint) z_in
WRITE (nprint) v_csoundMD

RETURN
END SUBROUTINE editMDmach
