SUBROUTINE editMDp( imin, imax, nx, jmin, jmax, ny, kmin, kmax, nz, x_in, &
& y_in, z_in, time, t_tb, pMD, nprint )
!-----------------------------------------------------------------------
!
!    File:         editMDp
!    Module:       editMDp
...
!
!    Purpose:
!  To perform an edit of the material pressure
!
!    Subprograms call:
