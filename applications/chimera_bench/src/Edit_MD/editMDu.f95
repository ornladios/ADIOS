SUBROUTINE editMDu( imin, imax, nx, jmin, jmax, ny, kmin, kmax, nz, x_in, &
& y_in, z_in, time, t_tb, uMD, nprint )
!-----------------------------------------------------------------------
!
!    File:         editMDu
!    Module:       editMDu
...
!  uMD          : radial velocity of zone [cm s^{-1}]
...
REAL(KIND=double), INTENT(in), DIMENSION(nx,ny,nz) :: uMD            ! radial velocity of zone [cm s^{-1}]
