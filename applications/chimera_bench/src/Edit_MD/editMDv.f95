SUBROUTINE editMDv( imin, imax, nx, jmin, jmax, ny, kmin, kmax, nz, x_in, &
& y_in, z_in, time, t_tb, vMD, nprint )
!-----------------------------------------------------------------------
!
!    File:         editMDv
!    Module:       editMDv
...
!  vMD          : angular (y) velocity of zone [cm s^{-1}]
...
REAL(KIND=double), INTENT(in), DIMENSION(nx,ny,nz) :: vMD            ! angular (y) velocity of zone [cm s^{-1}]
