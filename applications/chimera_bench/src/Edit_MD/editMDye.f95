SUBROUTINE editMDye( imin, imax, nx, jmin, jmax, ny, kmin, kmax, nz, x_in, &
& y_in, z_in, time, t_tb, yeMD, nprint )
!-----------------------------------------------------------------------
!
!    File:         editMDye
!    Module:       editMDye
...
REAL(KIND=double), INTENT(in), DIMENSION(nx,ny,nz) :: yeMD           ! electron of zone
