SUBROUTINE editMDyl( imin, imax, nx, jmin, jmax, ny, kmin, kmax, nz, x_in, &
& y_in, z_in, time, t_tb, ylMD, nprint )
!-----------------------------------------------------------------------
!
!    File:         editMDyl
!    Module:       editMDyl
...
!
!    Purpose:
!  To perform an edit of the electron fractions.
!
!    Subprograms call:
...
REAL(KIND=double), INTENT(in), DIMENSION(nx,ny,nz) :: ylMD           ! electron of zone
