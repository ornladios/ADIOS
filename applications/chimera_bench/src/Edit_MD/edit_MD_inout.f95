...
!  grav_z_c_in  : zone-centered y-component of gravitational acceleration [cm s^{-2} g^{-1}]
...
!-----------------------------------------------------------------------
  ...
  101 FORMAT (' Need MPI version of edit_MD_inout since n_proc=',i4,' > 1')
...
r_shock   (jmin:jmax,kmin:kmax) = r_shock_in   (jmin:jmax,kmin:kmax)
r_shock_mn(jmin:jmax,kmin:kmax) = r_shock_in_mn(jmin:jmax,kmin:kmax)
r_shock_mx(jmin:jmax,kmin:kmax) = r_shock_in_mx(jmin:jmax,kmin:kmax)
...
rsphere_mean(jmin,jmax,kmin:kmax) = rsphere_mean_in(jmin,jmax,kmin:kmax)
dsphere_mean(jmin,jmax,kmin:kmax) = dsphere_mean_in(jmin,jmax,kmin:kmax)
tsphere_mean(jmin,jmax,kmin:kmax) = tsphere_mean_in(jmin,jmax,kmin:kmax)
msphere_mean(jmin,jmax,kmin:kmax) = msphere_mean_in(jmin,jmax,kmin:kmax)
esphere_mean(jmin,jmax,kmin:kmax) = esphere_mean_in(jmin,jmax,kmin:kmax)
...
r_gain(1:2,jmin:jmax,kmin:kmax) = r_gain_in(1:2,jmin:jmax,kmin:kmax)
r_gain(5  ,jmin:jmax,kmin:kmax) = r_gain_in(5  ,jmin:jmax,kmin:kmax)
...
tau_heat_nuMD             = tau_heat_nu_in
tau_heat_nucMD            = tau_heat_nuc_in
...
wBVMD(imin:imax,:,:)      = wBV_in(jr_min:jr_min,:,:)
...
!-----------------------------------------------------------------------
!  x_O mass 16O fraction boundary
!-----------------------------------------------------------------------
...
aesvMD(jr_min:jr_max,:,:,:) = aesv(jr_min:jr_max,:,:,:)
r_comp                    = zero
DO i = imin,imax
  DO j = jmin,jmax
    DO k = kmin,kmax
...
&                         = dudt_nuc(jr_min:jr_max,jmin:jmax,kmin:kmax)

!-----------------------------------------------------------------------
!  Energy deposition rate by nuclear reactions
!-----------------------------------------------------------------------

dudt_nuMD(imin:imax,jmin:jmax,kmin:kmax)                                &
&                         = dudt_nu(jr_min:jr_max,jmin:jmax,kmin:kmax)
...
pMD_in(imin:imax,jmin:jmax,kmin:kmax)     = aesv(imin+1:imax+1,1 ,jmin:jmax,kmin:kmax)
eMD_in(imin:imax,jmin:jmax,kmin:kmax)     = aesv(imin+1:imax+1,2 ,jmin:jmax,kmin:kmax)
sMD_in(imin:imax,jmin:jmax,kmin:kmax)     = aesv(imin+1:imax+1,3 ,jmin:jmax,kmin:kmax)
e_nud_MD_in(imin:imax,jmin:jmax,kmin:kmax) = e_nu_MD_in   (imin:imax  ,jmin:jmax,kmin:kmax) &
...
rhoMD     (imin:imax  ,jmin:jmax,kmin:kmax) = rhoMD_in     (imin:imax  ,jmin:jmax,kmin:kmax)
uMD       (imin:imax  ,jmin:jmax,kmin:kmax) = uMD_in       (imin:imax  ,jmin:jmax,kmin:kmax)
vMD       (imin:imax  ,jmin:jmax,kmin:kmax) = vMD_in       (imin:imax  ,jmin:jmax,kmin:kmax)
wMD       (imin:imax  ,jmin:jmax,kmin:kmax) = wMD_in       (imin:imax  ,jmin:jmax,kmin:kmax)
sMD       (imin:imax  ,jmin:jmax,kmin:kmax) = sMD_in       (imin:imax  ,jmin:jmax,kmin:kmax)
aMD       (imin:imax  ,jmin:jmax,kmin:kmax) = aMD_in       (imin:imax  ,jmin:jmax,kmin:kmax)
yeMD      (imin:imax  ,jmin:jmax,kmin:kmax) = yeMD_in      (imin:imax  ,jmin:jmax,kmin:kmax)
v_csoundMD(imin:imax  ,jmin:jmax,kmin:kmax) = v_csoundMD_in(imin:imax  ,jmin:jmax,kmin:kmax)
e_nu_MD   (imin:imax  ,jmin:jmax,kmin:kmax) = e_nud_MD_in  (imin:imax  ,jmin:jmax,kmin:kmax)
f_nu_MD   (imin:imax+1,jmin:jmax,kmin:kmax) = f_nu_MD_in   (imin:imax+1,jmin:jmax,kmin:kmax)
grav_x_cMD(imin:imax  ,jmin:jmax,kmin:kmax) = grav_x_c_in  (imin:imax  ,jmin:jmax,kmin:kmax)
grav_y_cMD(imin:imax  ,jmin:jmax,kmin:kmax) = grav_y_c_in  (imin:imax  ,jmin:jmax,kmin:kmax)
grav_z_cMD(imin:imax  ,jmin:jmax,kmin:kmax) = grav_z_c_in  (imin:imax  ,jmin:jmax,kmin:kmax)

lumMD(imin:imax,:,jmin:jmax,kmin:kmax)    = lum_in(imin:imax,:,jmin:jmax,kmin:kmax)
e_rmsMD(imin:imax,:,jmin:jmax,kmin:kmax)  = e_rms_stat_in(imin:imax,:,jmin:jmax,kmin:kmax)
