SUBROUTINE esrgn_x( j, ij_ray, ik_ray, rho, t, ye )
!-----------------------------------------------------------------------
!
!    File:         esrgn_x
!    Module:       esrgn_x
...
!       created. Subroutine eosdtgen_x is called to fill this table
!       with eos quantities.
!
!    Input arguments:
!
...
!-----------------------------------------------------------------------
  ...
  101 FORMAT (' Table generation unsuccessful in esrgn_x, ncycle=',i7, &
& ' j=',i4,' ij_ray=',i4,' ik_ray=',i4,' rho, t, ye=',3(1pe11.3))
...
!-----------------------------------------------------------------------
!  The value of ye_min is set so that the lower cube corner value of ye
!   is at least one grid point away from zero.
!-----------------------------------------------------------------------
