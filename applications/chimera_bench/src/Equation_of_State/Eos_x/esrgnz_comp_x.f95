SUBROUTINE esrgnz_comp_x( jr_min, jr_max, rho, t, ye, ij_ray, ik_ray )
!-----------------------------------------------------------------------
!
!    File:         esrgnz_comp_x
!    Module:       esrgnz_comp_x
!    Type:         subprogram
...
!
!    Purpose:
!      To test each radial zone j between jr_min and jr_max to determine
!       if its thermodynamic state point is still within the local
!       table of nearest neighbor entries created for that zone in a
!       prior cycle. If not, or nse = 0, a new local table of nearest
!       neighbor entries is created. Subroutine eosdtgen_x is called to
...
!-----------------------------------------------------------------------
  ...
  101 FORMAT (' Table generation unsuccessful in esrgnz_comp_x, ncycle=',i7, &
& ' myid=',i4,' j=',i4,' ij_ray=',i3,' ik_ray=',i3,' rho, t, ye=',3(1pe11.3))
