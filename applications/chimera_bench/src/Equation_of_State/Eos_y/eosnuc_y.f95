...
!       composition of the material is given by the array xn(j,i).
!
!      The nucleons and nuclei are assumed to comprise an ideal
!       Boltzmann gas.
!
!    Variables that must be passed through common:
!  xn(j,i) : mass fraction of the ith nucleus in radial zone j.
...
USE eos_snc_y_module, ONLY : xn, a_nuc_rep, z_nuc_rep, be_nuc_rep, nuc_number, &
& a_nuc, z_nuc, be_nuc
...
!-----------------------------------------------------------------------
  ...
  101 FORMAT (' nnc =',i4,' > ncd=',i4,' in subroutine eosnuc_y.')
