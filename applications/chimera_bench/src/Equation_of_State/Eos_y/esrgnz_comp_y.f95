SUBROUTINE esrgnz_comp_y( jmin, jmax, rho, t, ye, ji_ray, jk_ray )
!-----------------------------------------------------------------------
!
!    File:         esrgnz_comp_y
!    Module:       esrgnz_comp_y
!    Type:         subprogram
...
!       neighbor entries is created. Subroutine eosdtgen_y is called to
...
!  cycle_module, edit_module, eos_snc_y_module, parallel_module
!
!-----------------------------------------------------------------------
...
REAL(KIND=double), INTENT(in), DIMENSION(ny) :: ye  ! shifted matter matter electron fraction array
...
REAL(KIND=double), DIMENSION(2,2) :: estmx
  ...
  101 FORMAT (' Table generation unsuccessful in esrgnz_comp_y, ncycle=',i7, &
& ' myid=',i4,' ji_ray=',i3,' jk_ray=',i4,' j=',i4,' rho, t, ye=',3(1pe11.3))
...
&      iy == iyr(j,ji_ray,jk_ray)  .and.   &
&      nse(j,ji_ray,jk_ray) == 1               ) CYCLE
