SUBROUTINE esrgnz_z( kmin, kmax, rho, t, ye, ki_ray, kj_ray )
!-----------------------------------------------------------------------
!
!    File:         esrgnz_z
!    Module:       esrgnz_z
...
!       is created. Subroutine esrgnz_z is called to fill this table
!       with eos quantities.
!
!    Input arguments:
...
!  cycle_module, edit_module, eos_snc_z_module, parallel_module
!
!-----------------------------------------------------------------------
...
REAL(KIND=double), DIMENSION(2,2) :: estmx
  ...
  101 FORMAT (' Table generation unsuccessful in esrgnz_z, ncycle=',i7, &
& ' myid=',i4,' j=',i4,' ki_ray=',i4,',kj_ray=',i4,' rho, t, ye=',3(1pe11.3))
...
!-----------------------------------------------------------------------
  ...
  &                                 = dlog10( estble(i,j,id,it,iy,kj_ray,ki_ray) + escnst(i,j,kj_ray,ki_ray) + epsilon )
        END DO
      END DO
    END DO
  END DO
