SUBROUTINE tgvndeye_comp_z( k, ki_ray, kj_ray, rho, e, ye, t_prev, t )
!-----------------------------------------------------------------------
!
!    File:         tgvndeye_comp_z
!    Module:       tgvndeye_comp_z
!    Type:         Subprogram
...
!-----------------------------------------------------------------------
 ...
 1001 FORMAT (' NR iteration for e will not converge in subroutine tgvndeye_comp_z, &
 &will try Bisection')
 1003 FORMAT (' k=',i4,' j_ray_bndl=',i4,' k_ray_bndl=',i4,' j_angular=',i4,' k_angular=',i4, &
...
& ' e=',es12.4,' e_test=',es12.4,' tmin=',es12.4,' tmax=',es12.4)
 ...
 &tgvndeye_comp_z')
 2005 FORMAT (' k=',i4,' j_ray_bndl=',i4,' k_ray_bndl=',i4,' j_angular=',i4,' k_angular=',i4, &
...
& nse(k,ki_ray,kj_ray), rho, t_prev, ye, e, e_test, t_test
...
DO it = 1,itmax
  ...
  WRITE (nlog,2001) it, nse(k, ki_ray, kj_ray), rho, t_test, ye, e, e_test, &
&  tmin, tmax
...
WRITE (nprint,2003)
WRITE (nprint,2005) k, j_ray_bndl, k_ray_bndl, j_angular, k_angular, myid, &
& nse(k,ki_ray, kj_ray), rho, t_prev, ye, e, e_test, t_test
WRITE (nprint,1005) (kk,(xn(kk,nc),nc=1,nnc),kk=k-1,k+1)
WRITE (nlog,2003)
...
RETURN
END SUBROUTINE tgvndeye_comp_z
