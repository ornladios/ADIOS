SUBROUTINE gamgr_nu_cal( jr_min, jr_max )
!-----------------------------------------------------------------------
!
!    File:         gamgr_nu_cal
!    Module:       gamgr_nu_cal
...
!
!  gamgr_nu(j) : inverse radial metric function at time m to be used
...
USE nu_dist_module, ONLY : gamgr_nu
...
!-----------------------------------------------------------------------
  ...
  201 FORMAT (' ireltrns =',i5,' not supported by gamgr_nu_cal')
