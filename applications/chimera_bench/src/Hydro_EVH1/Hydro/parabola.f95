SUBROUTINE parabola( nmin, nmax, nnz, para, a, deltaa, a6, al, flat, &
& iflat, iskip, ngeom )
!-----------------------------------------------------------------------
...
REAL(KIND=double), INTENT(in), DIMENSION(max_12) :: a        ! working array
REAL(KIND=double), INTENT(in), DIMENSION(max_12) :: flat     ! flaten array

!-----------------------------------------------------------------------
!        Output variables.
!-----------------------------------------------------------------------

REAL(KIND=double), INTENT(inout), DIMENSION(max_12) :: deltaa ! right - left
REAL(KIND=double), INTENT(inout), DIMENSION(max_12) :: al     ! left-hand value
REAL(KIND=double), INTENT(inout), DIMENSION(max_12) :: a6     ! parabolic coefficient
...
REAL(KIND=double), DIMENSION(max_12) :: ar       ! right-hand value
REAL(KIND=double), DIMENSION(max_12) :: da       ! left-hand value - right-hand value
REAL(KIND=double), DIMENSION(max_12) :: diffa    ! working array
REAL(KIND=double), DIMENSION(max_12) :: scrch1   ! working array
REAL(KIND=double), DIMENSION(max_12) :: scrch2   ! working array
REAL(KIND=double), DIMENSION(max_12) :: almon    ! working array
REAL(KIND=double), DIMENSION(max_12) :: armon    ! working array
