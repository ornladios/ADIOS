SUBROUTINE paraset( nnz, para, dx, xa, nmin, nmax, ngeom )
!-----------------------------------------------------------------------
...
REAL(KIND=double), DIMENSION(max_12)   :: a        ! working array, dX_j +  dX_j+1
REAL(KIND=double), DIMENSION(max_12)   :: b        ! working array, 2dX_j +  dX_j+1
REAL(KIND=double), DIMENSION(max_12)   :: c        ! working array, dX_j + 2dX_j+1
REAL(KIND=double), DIMENSION(max_12)   :: d        ! working array

REAL(KIND=double), DIMENSION(max_12)   :: ai       ! working array
REAL(KIND=double), DIMENSION(max_12)   :: bi       ! working array
REAL(KIND=double), DIMENSION(max_12)   :: ci       ! working array
