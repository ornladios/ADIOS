SUBROUTINE tgvndeye_sweep_comp_x( ni, nf, ij_ray, ik_ray, rho_f, rho_i )
!-----------------------------------------------------------------------
!                                                                      !
!    File:         tgvndeye_sweep_comp_x
!    Module:       tgvndeye_sweep_comp_x
!    Type:         Subprogram
...
!  tgvndsye_comp_x : updates the temperature if the degeneracy parameter is high
!  tgvndeye_comp_x : updates the temperature if the degeneracy parameter is low
...
&  ' in zone ',i4,' radial ray',2i4,' proc', i4,' in tgvndeye_sweep_comp_x; re(n)=', &
...
!-----------------------------------------------------------------------
    ...
    CALL tgvndsye_comp_x( n-5, ij_ray, ik_ray, re(n), se(n), yee(n), &
&    temp(n), t_out )
    temp(n)         = t_out
...
!-----------------------------------------------------------------------
    ...
    CALL tgvndeye_comp_x( n-5, ij_ray, ik_ray, re(n), ei(n), yee(n), &
&    temp(n), t_out )
    temp(n)         = t_out
...
RETURN
END SUBROUTINE tgvndeye_sweep_comp_x
