SUBROUTINE tgvndeye_sweep_x_rho( ni, nf, ij_ray, ik_ray, rho_f, rho_i )
!-----------------------------------------------------------------------
!
!    File:         tgvndeye_sweep_x_rho
!    Module:       tgvndeye_sweep_x_rho
!    Type:         Subprogram
...
RETURN
END SUBROUTINE tgvndeye_sweep_x_rho
