SUBROUTINE w_lt_wp_e_lt_wp( xl, xu, eta, h0i, h0ii, h1i, h1ii )
!-----------------------------------------------------------------------
!
!    File:         w_lt_wp_e_lt_wp
!    Module:       w_lt_wp_e_lt_wp
!    Type:         Subprogram
...
REAL(KIND=double)                  :: ga0           ! integrand variable
REAL(KIND=double)                  :: gp0           ! integrand variable
REAL(KIND=double)                  :: ga1           ! integrand variable
REAL(KIND=double)                  :: gp1           ! integrand variable
...
DO i = 1,nleg
  ...
  ga0              =  r8_3 * e2 * ( w3 - wp3 ) + 4.d0 * e * w_wp2 * ( w2/3.d0 + r2_3 * wwp + wp2 ) &
&      + 4.d0 * w_wp3 * ( w2/15.d0 + wwp/5.d0 + 0.4d0 * wp2 )
  gp0              =  r8_3 * e2 * ( w3 - wp3 ) + 4.d0 * e * w_wp2 * ( wp2/3.d0 + r2_3 * wwp + w2 ) &
&      + 4.d0 * w_wp3 * ( wp2/15.d0 + wwp/5.d0 + 0.4d0 * w2 )
...
&      - r4_3 * e3 * wp2 * w_wp2
  ...
  ga1              = r4_15 * e2 * w_wp3 * ( 4.d0 * w2 + 7.d0 * wwp + 4.d0 * wp2 ) &
&      + r2_15 * e * w_wp4 * ( 7.d0 * w2 + 14.d0 * wwp +  9.d0 * wp2 ) &
&      + r2_105 * w_wp5 * ( 11.d0 * w2 + 27.d0 * wwp + 18.d0 * wp2 )
  gp1              = r4_15 * e2 * w_wp3 * ( 4.d0 * wp2 + 7.d0 * wwp + 4.d0 * w2 ) &
&      + r2_15 * e * w_wp4 * ( 7.d0 * wp2 + 14.d0 * wwp + 9.d0 * w2 ) &
&      + r2_105 * w_wp5 * ( 11.d0 * wp2 + 27.d0 * wwp + 18.d0 * w2 )
...
END SUBROUTINE w_lt_wp_e_lt_wp
