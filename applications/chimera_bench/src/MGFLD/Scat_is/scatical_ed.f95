SUBROUTINE scatical_ed( rho, t, enu, xn, xp, xhe, xh, ah, zh, rmdnns, rmdnps, &
& rmdnhes, rmdnhs, coh )
!-----------------------------------------------------------------------
!
!    File:         scatical_ed
...
!
!    Purpose:
!      To calculate the zero and first legendre coefs for the n-type
!       isoenergetic scattering functions for editing purposes.
!
...
REAL(KIND=double), INTENT(out)    :: coh           ! sum of above
