SUBROUTINE g_sctnn( y_p, eta_star_p, g_fit )
!-----------------------------------------------------------------------
!
!
!    File:         g_sctnn
...
!
!    Purpose:
!      To compute the g_fit-component of the kernal for neutrino inelastic 
!       scattering in a nucleon field.
!
...
!
!    Input arguments:
!  g_fit       : dimensionless quantity related to S_{sigma}
!
!    Modules used:
