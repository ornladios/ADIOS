SUBROUTINE diffcr( jr_min, jr_max, ij_ray, ik_ray, r, u, nx )
!-----------------------------------------------------------------------
!
!    File:         diffcr
!    Module:       diffcr
...
!
!    Purpose:
!      To compute the diffusion coefficient, dcr
!
!    Subprograms called:
!        none
!
...
!
!    Output arguments:
!  dcr(j,k,n)  : diffusion coefficient for neutrinos at j, energy zone k, type n
!
!    Include files:
...
!-----------------------------------------------------------------------
 ...
 1001 FORMAT (' Allocation problem for array ',a10,' in diffcr')
 2001 FORMAT (' Deallocation problem for array ',a10,' in diffcr')
