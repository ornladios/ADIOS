SUBROUTINE setup_initial_GR( imin, imax, ij_ray, ik_ray, ij_ray_dim, &
& ik_ray_dim, nx, ny, nz, nez, nnu, rhop, rp, drp, agr_e, agr_c )
!-----------------------------------------------------------------------
!
!    File:         setup_initial_GR
!    Module:       setup_initial_GR
!    Type:         Subprogram
...
!-----------------------------------------------------------------------
  ...
  101 FORMAT (' Variable initialization complete in setup_initial_GR')
  103 FORMAT (' Newtonian rest masses computed in setup_initial_GR')
  ...
  201 FORMAT (' irelhy =',i5,' not supported in setup_initial_GR')
...
RETURN
END SUBROUTINE setup_initial_GR
