SUBROUTINE setup_restart_trans( imin, imax, ij_ray, ik_ray, ij_ray_dim, &
& ik_ray_dim, nx, nez, nnu, rhop, tp, yep, rp, drp, up, agr_e, agr_c, &
& psi0p, psi1p, rhobar )
!-----------------------------------------------------------------------
!
!    File:         setup_restart_trans
!    Module:       setup_restart_trans
!    Type:         Subprogram
...
!  mdl_cnfg_module, nu_dist_module, edit_module, mdl_cnfg_module,
...
!-----------------------------------------------------------------------
  ...
  101 FORMAT (' Variable initialization complete in setup_restart_trans')
  103 FORMAT (' Variable transfer complete in setup_restart_trans')
  111 FORMAT (' Neutrino gammas set in setup_restart_trans')
  113 FORMAT (' Neutrino lapse functions set in setup_restart_trans')
  115 FORMAT (' Relativistic neutrino group energies computed in setup_restart_trans')
  117 FORMAT (' Transport quantities computed in setup_restart_trans')
  119 FORMAT (' pblmst2 called in setup_restart_trans')
  121 FORMAT (' Haxton rates cmputed in setup_restart_trans')
  123 FORMAT (' Tabular ec rates read in setup_restart_trans')

  131 FORMAT (' Emission and absorption rates are being set in setup_restart_trans')
  133 FORMAT (' Emission and absorption rates have been deselected by options')
  135 FORMAT (' Emission and absorption rates have been set in setup_restart_trans')
  141 FORMAT (' Haxton rates are being set in setup_restart_trans')
  143 FORMAT (' Haxton rates have been deselected by options')
  145 FORMAT (' Haxton rates have been set in setup_restart_trans')
  151 FORMAT (' Neutrino-electron scattering rates are being set in setup_restart_trans')
  153 FORMAT (' Neutrino-electron scattering rates have been deselected by options')
  155 FORMAT (' Neutrino-electron scattering rates have been set in setup_restart_trans')
  161 FORMAT (' Neutrino-nucleon and nucleus isoenergetic scattering rates are being set in setup_restart_trans')
  163 FORMAT (' Neutrino-nucleon and nucleus isoenergetic scattering rates have been deselected by options')
  165 FORMAT (' Neutrino-nucleon and nucleus isoenergetic rates have been set in setup_restart_trans')
  171 FORMAT (' Electron-positron pair annihilation rates are being set in setup_restart_trans')
  173 FORMAT (' Electron-positron pair annihilation rates have been deselected by options')
  175 FORMAT (' Electron-positron pair annihilation rates have been set in setup_restart_trans')
  181 FORMAT (' Nucleon-nucleon bremsstrahlung rates are being set in setup_restart_trans')
  183 FORMAT (' Nucleon-nucleon bremsstrahlung rates have been deselected by options')
  185 FORMAT (' Nucleon-nucleon bremsstrahlung rates have been set in setup_restart_trans')
  191 FORMAT (' Neutrino-nucleon elastic scattering rates are being set in setup_restart_trans')
  193 FORMAT (' Neutrino-nucleon elastic scattering rates have been deselected by options')
  195 FORMAT (' Neutrino-nucleon elastic rates have been set in setup_restart_trans')
  201 FORMAT (' Neutrino-nucleon inelastic scattering rates are being set in setup_restart_trans')
  203 FORMAT (' Neutrino-nucleon inelastic scattering rates have been deselected by options')
  205 FORMAT (' Neutrino-nucleon inelastic rates have been set in setup_restart_trans')
  211 FORMAT (' Neutrino-nucleus inelastic scattering rates are being set in setup_restart_trans')
  213 FORMAT (' Neutrino-nucleus inelastic scattering rates have been deselected by options')
  215 FORMAT (' Neutrino-nucleus inelastic rates have been set in setup_restart_trans')

  301 FORMAT (' Emission and absorption rates interpolated in setup_restart_trans')
  303 FORMAT (' Isoenergetic scattering rates interpolated in setup_restart_trans')
  305 FORMAT (' Haxtons neutrino-nucleus inelastic scattering rates interpolated in setup_restart_trans')
  307 FORMAT (' Neutrino-electron elastic scattering rates interpolated in setup_restart_trans')
  309 FORMAT (' Electron-positron pair annihilation rates interpolated in setup_restart_trans')
  311 FORMAT (' Nucleon-nucleon bremsstrahlung rates interpolated in setup_restart_trans')
  313 FORMAT (' Neutrino-nucleon elastic scattering rates interpolated in setup_restart_trans')
  315 FORMAT (' Neutrino-nucleon inelastic scattering rates interpolated in setup_restart_trans')
  317 FORMAT (' Neutrino-nucleus inelastic scattering rates interpolated in setup_restart_trans')

  401 FORMAT (' Neutrino mean free paths computed in setup_restart_trans')
  403 FORMAT (' Neutrinospheres computed in setup_restart_trans')
  405 FORMAT (' Neutrinos diffusion coefficients computed in setup_restart_trans')
  407 FORMAT (' Neutrino-number data computed in setup_restart_trans')
  409 FORMAT (' Neutrino stresses computed in setup_restart_trans')
  411 FORMAT (' Neutrino Eddington factors computed in setup_restart_trans')
  413 FORMAT (' Neutrino energy densities computed in setup_restart_trans')
...
!-----------------------------------------------------------------------
!  Transfer variables back to radial_ray_module
!-----------------------------------------------------------------------
...
RETURN
END SUBROUTINE setup_restart_trans
