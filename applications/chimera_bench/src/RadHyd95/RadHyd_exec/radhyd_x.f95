SUBROUTINE radhyd_x( nx, ny, nz, nez, nnu, nnc, ndim, ij_ray_min, &
...
!  radhyd_to_remap_x          : transfer variables and perform the x-remap of all variables except total energy
...
!-----------------------------------------------------------------------
  ...
  101 FORMAT (' Need MPI version of radhyd_x since n_proc=',i4,' > 1')
...
!                    \\\\\ NEUTRINO X-STRESS /////
!
!  Neutrino stress is needed for the Lagrangian hydro steo
!-----------------------------------------------------------------------
