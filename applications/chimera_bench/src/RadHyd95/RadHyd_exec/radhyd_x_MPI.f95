SUBROUTINE radhyd_x_MPI( nx, ny, nz, nez, nnu, nnc, ndim, ij_ray_min, &
...
!    Include files:
!  kind_module
!  bomb_module, evh1_sweep, prb_cntl_module
!
!-----------------------------------------------------------------------
...
CALL radhyd_to_terminate_adios( ij_ray_min, ij_ray_max, ij_ray_dim, ik_ray_min, &
