SUBROUTINE radhyd_y( jmin, jmax, nx, ny, nz, nez, nnu, nnc, ndim, &
...
USE parallel_module, ONLY : myid, myid_y
...
!-----------------------------------------------------------------------
  ...
  101 FORMAT (' Need MPI version of radhyd_y since n_proc=',i4,' > 1')
