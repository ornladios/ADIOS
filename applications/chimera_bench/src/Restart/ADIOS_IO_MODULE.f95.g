...
#define ADIOS_WRITE(a,b) call adios_write(a,'b'//char(0),b)
  ...
  !--------------------------------------------------------------------------
  INTEGER, PRIVATE, PARAMETER         :: nz_hyperslabs = 8
...
! added by zf
    ...
    WRITE(suffix, fmt='(i9.9,a7,i4.4,a1,i4.4,a3)') ncycle,'_group_',my_hyperslab_group,'_',myid,'.bp'
...
call adios_write(handle,"nx"//char(0),nx)
call adios_write(handle,"nx+1"//char(0),nx+1)
call adios_write(handle,"ny"//char(0),ny)
call adios_write(handle,"mpi_comm_per_hyperslab_group"//char(0),mpi_comm_per_hyperslab_group)
call adios_write(handle,"ny+1"//char(0),ny+1)
call adios_write(handle,"nz"//char(0),nz)
call adios_write(handle,"nz+1"//char(0),nz+1)
call adios_write(handle,"nez"//char(0),nez)
call adios_write(handle,"nnu"//char(0),nnu)
call adios_write(handle,"nnu+1"//char(0),nnu+1)
call adios_write(handle,"nnc"//char(0),nnc)
call adios_write(handle,"ij_ray_dim"//char(0),my_j_ray_dim)
call adios_write(handle,"ik_ray_dim"//char(0),my_k_ray_dim)
call adios_write(handle,"array_dimensions"//char(0),array_dimensions)
call adios_write(handle,"time"//char(0),time)
call adios_write(handle,"cycle"//char(0),ncycle)
call adios_write(handle,"nz_hyperslabs"//char(0),nz_hyperslabs)
call adios_write(handle,"my_hyperslab_group"//char(0),my_hyperslab_group)
call adios_write(handle,"nz_hyperslab_width"//char(0),nz_hyperslab_width)
call adios_write(handle,"radial_index_bound"//char(0),radial_index_bound)
call adios_write(handle,"theta_index_bound"//char(0),theta_index_bound)
call adios_write(handle,"phi_index_bound"//char(0),phi_index_bound)
call adios_write(handle,"x_ef"//char(0),x_ef)
call adios_write(handle,"y_ef"//char(0),y_ef)
call adios_write(handle,"z_ef"//char(0),z_ef)
call adios_write(handle,"x_cf"//char(0),x_cf)
call adios_write(handle,"y_cf"//char(0),y_cf)
call adios_write(handle,"z_cf"//char(0),z_cf)
call adios_write(handle,"dx_cf"//char(0),dx_cf)
call adios_write(handle,"dy_cf"//char(0),dy_cf)
call adios_write(handle,"dz_cf"//char(0),dz_cf)
call adios_write(handle,"rho_c"//char(0),rho_c)
call adios_write(handle,"t_c"//char(0),t_c)
call adios_write(handle,"ye_c"//char(0),ye_c)
call adios_write(handle,"u_c"//char(0),u_c)
call adios_write(handle,"v_c"//char(0),v_c)
call adios_write(handle,"w_c"//char(0),w_c)
call adios_write(handle,"psi0_c"//char(0),psi0_c)
call adios_write(handle,"psi1_e"//char(0),psi1_e)
call adios_write(handle,"dnurad"//char(0),dnurad)
call adios_write(handle,"unukrad"//char(0),unukrad)
call adios_write(handle,"unujrad"//char(0),unujrad)
call adios_write(handle,"e_rad"//char(0),e_rad)
call adios_write(handle,"unurad"//char(0),unurad)
call adios_write(handle,"nnukrad"//char(0),nnukrad)
call adios_write(handle,"nnujrad"//char(0),nnujrad)
call adios_write(handle,"elec_rad"//char(0),elec_rad)
call adios_write(handle,"nnurad"//char(0),nnurad)
call adios_write(handle,"e_nu_c_bar"//char(0),e_nu_c_bar)
call adios_write(handle,"f_nu_e_bar"//char(0),f_nu_e_bar)
call adios_write(handle,"nu_r"//char(0),nu_r)
call adios_write(handle,"nu_rt"//char(0),nu_rt)
call adios_write(handle,"nu_rho"//char(0),nu_rho)
call adios_write(handle,"nu_rhot"//char(0),nu_rhot)
call adios_write(handle,"psi0dat"//char(0),psi0dat)
call adios_write(handle,"psi1dat"//char(0),psi1dat)
call adios_write(handle,"nse_c"//char(0),nse_c)
call adios_write(handle,"xn_c"//char(0),xn_c)
call adios_write(handle,"a_nuc_rep_c"//char(0),a_nuc_rep_c)
call adios_write(handle,"z_nuc_rep_c"//char(0),z_nuc_rep_c)
call adios_write(handle,"be_nuc_rep_c"//char(0),be_nuc_rep_c)
call adios_write(handle,"uburn_c"//char(0),uburn_c)
call adios_write(handle,"duesrc"//char(0),duesrc)
call adios_write(handle,"pMD"//char(0),pMD)
call adios_write(handle,"sMD"//char(0),sMD)
call adios_write(handle,"dudt_nuc"//char(0),dudt_nuc)
call adios_write(handle,"dudt_nu"//char(0),dudt_nu)
call adios_write(handle,"grav_x_c"//char(0),grav_x_c)
call adios_write(handle,"grav_y_c"//char(0),grav_y_c)
call adios_write(handle,"grav_z_c"//char(0),grav_z_c)
call adios_write(handle,"agr_e"//char(0),agr_e)
call adios_write(handle,"agr_c"//char(0),agr_c)
call adios_write(handle,"r_shock"//char(0),r_shock)
call adios_write(handle,"r_shock_mn"//char(0),r_shock_mn)
call adios_write(handle,"r_shock_mx"//char(0),r_shock_mx)
call adios_write(handle,"tau_adv"//char(0),tau_adv)
call adios_write(handle,"tau_heat_nu"//char(0),tau_heat_nu)
call adios_write(handle,"tau_heat_nuc"//char(0),tau_heat_nuc)
call adios_write(handle,"r_nse"//char(0),r_nse)
call adios_write(handle,"rsphere_mean"//char(0),rsphere_mean)
call adios_write(handle,"dsphere_mean"//char(0),dsphere_mean)
call adios_write(handle,"tsphere_mean"//char(0),tsphere_mean)
call adios_write(handle,"msphere_mean"//char(0),msphere_mean)
call adios_write(handle,"esphere_mean"//char(0),esphere_mean)
call adios_write(handle,"r_gain"//char(0),r_gain)
call adios_write(handle,"unu_c"//char(0),unu_c)
call adios_write(handle,"dunu_c"//char(0),dunu_c)
call adios_write(handle,"unue_e"//char(0),unue_e)
call adios_write(handle,"dunue_e"//char(0),dunue_e)
