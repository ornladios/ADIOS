...
!!XY for rolling restart
  integer miNtmp,meNtmp,ntracerNtmp
...
!!XY for rolling restart
  real(wp),dimension(:,:),allocatable :: zionNtmp,zion0Ntmp,zelectronNtmp,zelectron0Ntmp
...
!!XY rolling restart
  real(wp),dimension(:),allocatable :: phip00Ntmp,zonaliNtmp,zonaleNtmp
  real(wp),dimension(:,:),allocatable :: phiNtmp
  real(wp),dimension(:,:,:),allocatable :: phisaveNtmp
...
!!XY for rolling restart
  real(wp),dimension(:),allocatable :: rdtemiNtmp,rdtemeNtmp,pfluxpsiNtmp
  real(wp) etracerNtmp,ptracerNtmp(4)
