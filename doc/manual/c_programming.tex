...
to display the content of the file or use one of the converters (bp2h5), to produce the user's preferred file format (HDF5) and use its dump utility to output the content in the standard output. 
...
a single global array (and also the HDF5 file when using our converter). 
