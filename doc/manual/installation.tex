...
versions 2.5, 2.6 and 2.7. Note that ADIOS does NOT work with version 2.8.
...
environment compatible with ADIOS 1.7, run the bootstrap script with
``adios-1.7'' as a version tag:
\begin{lstlisting}
  perl ./chaos_bootstrap.pl adios-1.7 [optional install directory]
\end{lstlisting}
