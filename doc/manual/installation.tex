...
On newer Cray machines (XK6 and XE6) with the Gemini network, the \verb+PMI+ and \verb+uGNI+ libraries are used by the staging methods. ADIOS configure usually finds them automatically, but if not, configure ADIOS with the options
