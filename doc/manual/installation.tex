...
environment compatible with ADIOS 1.13.1, run the bootstrap script with
``adios-1.13.1'' as a version tag:
\begin{lstlisting}
  perl ./korvo_bootstrap.pl adios-1.13.1 [install_path]
\end{lstlisting}
...
korvogithub cmake -DBUILD_SHARED_LIBS=OFF -DBUILD_SHARED_STATIC=STATIC -DCMAKE_C_FLAGS=-fPIC -DCMAKE_CXX_FLAGS=-fPIC
\end{lstlisting}
