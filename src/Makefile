...
#am__append_2 = -DPHDF5 -DH5_USE_16_API 
...
am__libadios_a_SOURCES_DIST = adios.c adios_transport_hooks.c \
	...
	adios_socket.c adios_bp_v1.c adios_mpi_nwu.c adios_phdf5.c
...
am_libadios_a_OBJECTS = libadios_a-adios.$(OBJEXT) \
	...
	libadios_a-adios_mpi_nwu.$(OBJEXT) $(am__objects_1)
...
ACLOCAL = ${SHELL} /ccs/home/cgj/e2e/cgj/adios.svn/trunk_nwu/config/missing --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /ccs/home/cgj/e2e/cgj/adios.svn/trunk_nwu/config/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /ccs/home/cgj/e2e/cgj/adios.svn/trunk_nwu/config/missing --run autoconf
AUTOHEADER = ${SHELL} /ccs/home/cgj/e2e/cgj/adios.svn/trunk_nwu/config/missing --run autoheader
AUTOMAKE = ${SHELL} /ccs/home/cgj/e2e/cgj/adios.svn/trunk_nwu/config/missing --run automake-1.9
AWK = gawk
CC = mpicc
...
HAVE_PHDF5_FALSE = 
HAVE_PHDF5_TRUE = #
HDF5_CPPFLAGS = -I/sw/analysis-x64/hdf5/1.6.7/sl5.0_pgi7.1.5_ompi1.2.6/include
HDF5_LDFLAGS = -L/sw/analysis-x64/hdf5/1.6.7/sl5.0_pgi7.1.5_ompi1.2.6/lib
HDF5_LIBS = -lhdf5
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /ccs/home/cgj/e2e/cgj/adios.svn/trunk_nwu/config/missing --run makeinfo
MPICC = mpicc
MPIFC = mpif90
MPILIBS =  
MXML_CPPFLAGS = -I/ccs/home/ge1/work/lens/include
MXML_LDFLAGS = -L/ccs/home/ge1/work/lens/lib
MXML_LIBS = -lmxml
NETCDF_CPPFLAGS = -I/sw/analysis-x64/netcdf/3.6.2/sl5.0_pgi7.1.5/include
NETCDF_LDFLAGS = -L/sw/analysis-x64/netcdf/3.6.2/sl5.0_pgi7.1.5/lib
NETCDF_LIBS = -lnetcdf
OBJEXT = o
PACKAGE = ADIOS
PACKAGE_BUGREPORT = 
...
infodir = ${prefix}/info
install_sh = /ccs/home/cgj/e2e/cgj/adios.svn/trunk_nwu/config/install-sh
...
prefix = /autofs/na1_sw/analysis-x64/adios/0.9.8/sl5.2_mvapich_pgi0.9.9
...
include_HEADERS = adios.h adios_types.h adios_internals.h \
	adios_transport_hooks.h
lib_LIBRARIES = libadios.a $(am__append_1) libadios_int.a
libadios_a_SOURCES = adios.c adios_transport_hooks.c adios_mpi.c \
	adios_mpi_cio.c adios_posix.c adios_posix_ascii.c adios_vtk.c \
	adios_provenance.c adios_internals.c adios_socket.c \
	adios_bp_v1.c adios_mpi_nwu.c $(am__append_3)
...
libadios_a-adios_mpi_nwu.o: adios_mpi_nwu.c
	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libadios_a_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o libadios_a-adios_mpi_nwu.o `test -f 'adios_mpi_nwu.c' || echo '$(srcdir)/'`adios_mpi_nwu.c

libadios_a-adios_mpi_nwu.obj: adios_mpi_nwu.c
	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libadios_a_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o libadios_a-adios_mpi_nwu.obj `if test -f 'adios_mpi_nwu.c'; then $(CYGPATH_W) 'adios_mpi_nwu.c'; else $(CYGPATH_W) '$(srcdir)/adios_mpi_nwu.c'; fi`
