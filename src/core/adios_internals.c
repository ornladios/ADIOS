        ...
        )
{
    ...
    adios_common_define_attribute (p_new_group,dims,"/",adios_int,counterstr,"");
        ...
        )
{
    ...
    adios_common_define_attribute (p_new_group,maxa,"/",adios_int,counterstr,"");
    free (maxa);
    free (d1);
        ...
        )
{
    ...
    adios_common_define_attribute (p_new_group,orgs,"/",adios_int,counterstr,"");
        ...
        )
{
    ...
    adios_common_define_attribute (p_new_group,spas,"/",adios_int,counterstr,"");
    free (spas);
        ...
        )
{
    ...
    if (counter > 1) {
        ...
        adios_common_define_attribute (p_new_group,coords,"/",adios_int,counterstr,"");
        free (coords);
    } else
    {
        ...
        )
{
    ...
    if (counter > 1){
        ...
        adios_common_define_attribute (p_new_group,pts,"/",adios_int,counterstr,"");
        free (pts);
    } else
    {
