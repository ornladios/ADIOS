...
static int defineVarTimeSeriesFormat (const char * timeseries
...
static int defineVarTimeScale (const char * timescale
        ,struct adios_group_struct * new_group
        ,const char * name
        )
{
...
static int defineVarHyperSlab ( const char * hyperslab,
        struct adios_group_struct * new_group,
        const char * name)
{
    char * c;                      // comma location
...
static int defineVarTimeSteps (const char * timesteps
        ,struct adios_group_struct * new_group
        ,const char * name
        )
{
