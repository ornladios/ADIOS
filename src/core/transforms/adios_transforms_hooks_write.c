...
uint64_t adios_transform_transformed_size_growth(
    ...
    return TRANSFORM_WRITE_METHODS[var->transform_type].transform_transformed_size_growth(var, transform_spec, constant_factor, linear_factor, capped_linear_factor, capped_linear_cap);
}
