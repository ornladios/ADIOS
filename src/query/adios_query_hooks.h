...
#define FORWARD_DECLARE(a) \
  ...
  int     adios_query_##a##_get_selection(ADIOS_QUERY* q, uint64_t batchSize, ADIOS_SELECTION* outputBoundry, ADIOS_SELECTION** result); \
...
{
  ADIOS_QUERY_GET_SELECTION_FN  adios_query_get_selection_fn;
