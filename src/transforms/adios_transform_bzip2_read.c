...
int adios_transform_bzip2_generate_read_subrequests(adios_transform_read_reqgroup *reqgroup,
...
adios_datablock * adios_transform_bzip2_subrequest_completed(adios_transform_read_reqgroup *reqgroup,
																adios_transform_pg_reqgroup *pg_reqgroup,
...
adios_datablock * adios_transform_bzip2_pg_reqgroup_completed(adios_transform_read_reqgroup *reqgroup,
...
adios_datablock * adios_transform_bzip2_reqgroup_completed(adios_transform_read_reqgroup *completed_reqgroup,
																enum ADIOS_READ_RESULT_MODE mode) 
{
	return NULL;
}
