program writer
  ...
  write (local,  '(i3.3,",",i3.3)') nx_local, ny_local
  write (global, '(i3.3,",",i3.3)') nx_global, ny_global
  write (offset, '(i3.3,",",i3.3)') offs_x, offs_y
  !print '("rank=",i2," local=",a," global=",a," offset=",a)', &
  !       rank, local, global, offset
