...
public class adioslibJNI {
  ...
  public final static native int MPI_UINT64_T_get();
  ...
  public final static native int MPI_Allreduce(long jarg1, long jarg2, int jarg3, int jarg4, int jarg5, int jarg6);
  ...
  public final static native long ADIOS_FILE_getFh(long jarg1, ADIOS_FILE jarg1_);
  ...
  public final static native long ADIOS_VARINFO_getDims(long jarg1, ADIOS_VARINFO jarg1_, int jarg2);
  ...
  public final static native void ADIOS_AVAILABLE_READ_METHODS_nmethods_set(long jarg1, ADIOS_AVAILABLE_READ_METHODS jarg1_, int jarg2);
  public final static native int ADIOS_AVAILABLE_READ_METHODS_nmethods_get(long jarg1, ADIOS_AVAILABLE_READ_METHODS jarg1_);
  public final static native void ADIOS_AVAILABLE_READ_METHODS_name_set(long jarg1, ADIOS_AVAILABLE_READ_METHODS jarg1_, long jarg2);
  public final static native long ADIOS_AVAILABLE_READ_METHODS_name_get(long jarg1, ADIOS_AVAILABLE_READ_METHODS jarg1_);
  public final static native void ADIOS_AVAILABLE_READ_METHODS_methodID_set(long jarg1, ADIOS_AVAILABLE_READ_METHODS jarg1_, long jarg2);
  public final static native long ADIOS_AVAILABLE_READ_METHODS_methodID_get(long jarg1, ADIOS_AVAILABLE_READ_METHODS jarg1_);
  public final static native long new_ADIOS_AVAILABLE_READ_METHODS();
  public final static native void delete_ADIOS_AVAILABLE_READ_METHODS(long jarg1);
  public final static native long adios_available_read_methods();
  public final static native void adios_available_read_methods_free(long jarg1, ADIOS_AVAILABLE_READ_METHODS jarg1_);
  public final static native int adios_init(String jarg1, int jarg2);
  public final static native int adios_is_initialized();
  public final static native int adios_finalize(int jarg1);
  public final static native int adios_open(long[] jarg1, String jarg2, String jarg3, String jarg4, int jarg5);
  public final static native int adios_group_size(long jarg1, java.math.BigInteger jarg2, long jarg3);
  public final static native int adios_write(long jarg1, String jarg2, long jarg3);
  public final static native int adios_get_write_buffer(long jarg1, String jarg2, long jarg3, long jarg4);
  public final static native int adios_read(long jarg1, String jarg2, long jarg3, java.math.BigInteger jarg4);
  public final static native int adios_set_path(long jarg1, String jarg2);
  public final static native int adios_set_path_var(long jarg1, String jarg2, String jarg3);
  public final static native int adios_end_iteration();
  public final static native int adios_start_calculation();
  public final static native int adios_stop_calculation();
  public final static native int adios_close(long jarg1);
  public final static native int adios_init_noxml(int jarg1);
  public final static native int adios_allocate_buffer(int jarg1, java.math.BigInteger jarg2);
  public final static native void adios_set_max_buffer_size(java.math.BigInteger jarg1);
  public final static native int adios_declare_group(long jarg1, String jarg2, String jarg3, int jarg4);
  public final static native int adios_free_group(long jarg1);
  public final static native int adios_set_time_aggregation(long jarg1, java.math.BigInteger jarg2, long jarg3);
  public final static native int adios_select_method(long jarg1, String jarg2, String jarg3, String jarg4);
  public final static native long adios_define_var(long jarg1, String jarg2, String jarg3, int jarg4, String jarg5, String jarg6, String jarg7);
  public final static native int adios_delete_vardefs(long jarg1);
  public final static native java.math.BigInteger adios_expected_var_size(long jarg1);
  public final static native int adios_set_transform(long jarg1, String jarg2);
  public final static native int adios_define_attribute(long jarg1, String jarg2, String jarg3, int jarg4, String jarg5, String jarg6);
  public final static native int adios_define_attribute_byvalue(long jarg1, String jarg2, String jarg3, int jarg4, int jarg5, long jarg6);
  public final static native int adios_delete_attrdefs(long jarg1);
  public final static native int adios_write_byid(long jarg1, long jarg2, long jarg3);
  public final static native void adios_timing_write_xml(long jarg1, String jarg2);
  public final static native int adios_define_schema_version(long jarg1, String jarg2);
  public final static native int adios_define_var_mesh(long jarg1, String jarg2, String jarg3);
  public final static native int adios_define_var_centering(long jarg1, String jarg2, String jarg3);
  public final static native int adios_define_mesh_file(long jarg1, String jarg2, String jarg3);
  public final static native int adios_define_var_timesteps(String jarg1, long jarg2, String jarg3);
  public final static native int adios_define_var_timescale(String jarg1, long jarg2, String jarg3);
  public final static native int adios_define_var_timeseriesformat(String jarg1, long jarg2, String jarg3);
  public final static native int adios_define_var_hyperslab(String jarg1, long jarg2, String jarg3);
  public final static native int adios_define_mesh_timevarying(String jarg1, long jarg2, String jarg3);
  public final static native int adios_define_mesh_timesteps(String jarg1, long jarg2, String jarg3);
  public final static native int adios_define_mesh_timescale(String jarg1, long jarg2, String jarg3);
  public final static native int adios_define_mesh_timeseriesformat(String jarg1, long jarg2, String jarg3);
  public final static native int adios_define_mesh_group(String jarg1, long jarg2, String jarg3);
  public final static native int adios_define_mesh_uniform(String jarg1, String jarg2, String jarg3, String jarg4, String jarg5, long jarg6, String jarg7);
  public final static native int adios_define_mesh_rectilinear(String jarg1, String jarg2, String jarg3, long jarg4, String jarg5);
  public final static native int adios_define_mesh_structured(String jarg1, String jarg2, String jarg3, long jarg4, String jarg5);
  public final static native int adios_define_mesh_unstructured(String jarg1, String jarg2, String jarg3, String jarg4, String jarg5, String jarg6, long jarg7, String jarg8);
  public final static native void ADIOS_AVAILABLE_WRITE_METHODS_nmethods_set(long jarg1, ADIOS_AVAILABLE_WRITE_METHODS jarg1_, int jarg2);
  public final static native int ADIOS_AVAILABLE_WRITE_METHODS_nmethods_get(long jarg1, ADIOS_AVAILABLE_WRITE_METHODS jarg1_);
  public final static native void ADIOS_AVAILABLE_WRITE_METHODS_name_set(long jarg1, ADIOS_AVAILABLE_WRITE_METHODS jarg1_, long jarg2);
  public final static native long ADIOS_AVAILABLE_WRITE_METHODS_name_get(long jarg1, ADIOS_AVAILABLE_WRITE_METHODS jarg1_);
  public final static native long new_ADIOS_AVAILABLE_WRITE_METHODS();
  public final static native void delete_ADIOS_AVAILABLE_WRITE_METHODS(long jarg1);
  public final static native long adios_available_write_methods();
  public final static native void adios_available_write_methods_free(long jarg1, ADIOS_AVAILABLE_WRITE_METHODS jarg1_);
  ...
  public final static native int adios_write_double_arr(long jarg1, String jarg2, double[] jarg3);
  public final static native int adios_write_int_arr(long jarg1, String jarg2, int[] jarg3);
  public final static native int adios_write_double(long jarg1, String jarg2, double jarg3);
  public final static native int adios_write_int(long jarg1, String jarg2, int jarg3);
}
